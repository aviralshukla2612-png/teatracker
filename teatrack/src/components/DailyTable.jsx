...
export default function DailyTable({ entries, onEdit, onDelete, currentUser, onView }) {
  return (
              ...
              <tr key={entry.id || idx}>
                ...
                <td>
                  <div className="action-cell">
                    <button
                      className="tbl-btn tbl-view-btn"
                      title="View Details"
                      onClick={() => (onView ? onView(entry) : (onEdit && onEdit(entry)))}
                    >
